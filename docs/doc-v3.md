...
Compatível com **Laravel 8**.<br>
Suporta vários grupos de permissões por usuário.<br> 
Views compatívieis com laravel/breeze e Tailwind CSS.<br>
...
-   [**Aplicações de teste**](https://github.com/tjgazel/docblock-acl-testes)
...
![Screenshot 01](./screenshot04.png)
...
As views ACL a partir da versão 3 extendem o template `resource/views/layouts/app.blade.php` fornecidas pelo laravel/breeze. Você pode edita-las a seu gosto. Path `resources/views/vendor/acl`.
...
O pacote tráz um componente de alerta que já faz todo este trabalho. Inclua o arquivo no seu modelo de layout.
